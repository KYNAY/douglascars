...
-- IMPORTANTE: Inserir os dados na ordem correta para evitar erros de chave estrangeira

-- 1. Inserir dados na tabela brands primeiro (não depende de outras tabelas)
...
-- 2. Inserir dados na tabela dealers (antes de sales que depende dela)
...
-- 3. Inserir dados na tabela vehicles (após brands, antes de sales e vehicle_images)
...
-- 4. Agora podemos inserir dados nas tabelas que dependem de vehicles
...
-- 5. Inserir dados na tabela sales (depois de vehicles e dealers)
